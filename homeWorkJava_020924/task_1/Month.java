package de.telran.homeWorkJava_020924.task_1;
//Enum для хранения месяцев в году на русском языке
    ...
    public String recommendDiet() {
        switch (this) {
            case DECEMBER, JANUARY, FEBRUARY:
                return "Это зима! Питайтесь калорийными блюдами, чтобы сохранять тепло.";
